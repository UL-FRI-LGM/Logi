 ...
 */
template <typename OwnerType, typename Type, typename Dispatch,
          void (OwnerType::*deleter)(Type, const vk::AllocationCallbacks*, const Dispatch&) const>
class ManagedResource {
 public:
   ...
   */
  ManagedResource(const OwnerType& owner_object, const Type& object,
                  vk::AllocationCallbacks* allocation_callbacks = nullptr, const Dispatch& dispatch = Dispatch());
 ...
 private:
  ...
  /**
   * @brief Allocation callbacks.
   */
  vk::AllocationCallbacks* allocation_callbacks_;
...
template <typename OwnerType, typename Type, typename Dispatch,
          void (OwnerType::*deleter)(Type, const vk::AllocationCallbacks*, const Dispatch&) const>
ManagedResource<OwnerType, Type, Dispatch, deleter>::ManagedResource()
  : owner_object_(nullptr), object_(nullptr), allocation_callbacks_(nullptr), dispatch_() {}

template <typename OwnerType, typename Type, typename Dispatch,
          void (OwnerType::*deleter)(Type, const vk::AllocationCallbacks*, const Dispatch&) const>
ManagedResource<OwnerType, Type, Dispatch, deleter>::ManagedResource(const OwnerType& owner_object, const Type& object,

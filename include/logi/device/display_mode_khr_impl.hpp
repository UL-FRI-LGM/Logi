...
#ifndef LOGI_DEVICE_DISPLAY_MODE_KHR_IMPL_HPP
...
class DisplayModeKHRImpl : public VulkanObject, public std::enable_shared_from_this<DisplayModeKHRImpl> {
 public:
  ...
  DisplayKHRImpl& getDisplay() const;
 ...
 private:
  DisplayKHRImpl& display_;
  std::optional<vk::AllocationCallbacks> allocator_;
  vk::DisplayModeKHR vkDisplayModeKHR_;
};

} // namespace logi

#endif // LOGI_DEVICE_DISPLAY_MODE_KHR_IMPL_HPP

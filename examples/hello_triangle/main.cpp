...
public:
	...
	void buildCommandBuffers() {
		for (const logi::Framebuffer& framebuffer : framebuffers) {
			...
			const vk::CommandBuffer& cmd_buffer = cmd_buffers.back().getVkHandle();
			...
			render_pass_info.renderPass = render_pass.getVkHandle();
			render_pass_info.framebuffer = framebuffer.getVkHandle();
			...
			cmd_buffer.bindPipeline(vk::PipelineBindPoint::eGraphics, pipeline.getVkHandle());

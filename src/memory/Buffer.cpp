...
BufferConfiguration::BufferConfiguration(vk::BufferCreateFlags flags, vk::DeviceSize size, vk::BufferUsageFlags usage, MemoryUsage memory_usage, std::vector<uint32_t> concurrent_queue_families)
